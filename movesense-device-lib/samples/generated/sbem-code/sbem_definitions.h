...
DECLARE_GROUP(SAMPLE_SENSOROUTPUT_)
DECLARE_GROUP(WHITEBOARD_METRICS_COMM_)

extern const DescriptorItem_t s_possibleSbemItems[51];
...
COMMON_TIMEISO8601 = CommonValueIds_e::TIMEISO8601,
    ...
    MEAS_TEMP_TIMESTAMP,
    SAMPLE_SENSOROUTPUT_GAPS,
    SAMPLE_SENSOROUTPUT_PROBESBAD,
    SAMPLE_SENSOROUTPUT_PROBESGOOD,
...
extern const SbemResID2GrpIdMapping s_sbemResID2GrpIdMap[67];
