...
struct WB_ALIGN(4) HelloWorldValue;

struct WB_ALIGN(4) HelloWorldValue
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 25856;

	WB_ALIGN(4) whiteboard::WrapperFor32BitPointer<const char> greeting;
};
...
struct SAMPLE_HELLOWORLD
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_APPLICATION;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 25856, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 25856;

	struct GET
	{
		typedef whiteboard::StronglyTypedResult<const HelloWorldValue&, whiteboard::HTTP_CODE_OK> HTTP_CODE_OK;
	...
	struct EVENT
	{
		typedef HelloWorldValue NotificationType;
