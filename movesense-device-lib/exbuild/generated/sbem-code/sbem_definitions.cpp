...
CREATE_GROUP(SAMPLE_HELLOWORLD_,
    static_cast<uint16_t>(SAMPLE_HELLOWORLD_GREETING));
...
const DescriptorItem_t s_possibleSbemItems[] = {
    ...
    {SAMPLE_HELLOWORLD_GREETING, "<PTH>Sample+HelloWorld.Greeting\n<FRM>utf8"},
